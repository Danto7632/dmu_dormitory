...
export class UpdateStudentDto {
  ...
  @ApiPropertyOptional({ description: '층수 (2-9)', example: 4 })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({ description: '호실', example: '401' })
  @IsOptional()
  @IsString()
  roomNo?: string;

  @ApiPropertyOptional({ description: '보호자 연락처', example: '010-1234-5678' })
  @IsOptional()
  @IsString()
